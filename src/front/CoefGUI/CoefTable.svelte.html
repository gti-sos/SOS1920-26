...
<main>
	...
	<Button type="button" class="btn btn-primary"  onclick="window.location.href='#/global-coef/graph'" style="margin-left: 6.75%; width: 25%;"> Gráfica Coef</Button>
	<Button type="button" class="btn btn-primary"  onclick="window.location.href='#/global-coef/graph2'" style="margin-left: 6.75%; width: 25%;"> Gráfica Coef2</Button>
</main>