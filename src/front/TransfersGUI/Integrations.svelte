...
<div class="row">
    ...
    <button type="button" class="btn btn-success" onclick="window.location.href='#/integrations/global-transfers/integrationsExt2'" style="margin-left: 26%; width: 25%;"> Integración API EXTERNA 2</button>
</div>
