...
<main>
	...
	<Button color="info" type="button" class="btn btn-primary"  onclick="window.location.href='#/goalscorers/graphs/graph2'" style="margin-left: 20px;"> Gráfica Goleadores [Chart.js]</Button>
</main>